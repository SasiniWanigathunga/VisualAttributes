...
def generate_prompt(category_name: str):
    ...
    return f"""Q: What are useful visual attributes for distinguishing a lemur from other objects in a photo?
...
Q: What are useful visual attributes for distinguishing a television from other objects in a photo?
...
Q: What are useful visual attributes for distinguishing a {category_name} from other objects in a photo?
A: There are several useful visual attributes to tell there is a {category_name} from other objects in a photo:
-
"""
